...
// TYPE INFERENCE je veoma dobar za nas jer ne moramo da oznacavamo type za svaku stvar,
...
// a to je 'let proizvod: string', isto tako za reinicijalizaciju 'let proizvod: string'.
// Takodje za promenljivu price, 'let price: number'.
...
// function imeKursa({ name }: nekiProizvod) {
//   return name;
// }
